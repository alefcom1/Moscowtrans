...
<?php wp_body_open(); ?>
  ...
  <header class="site-header">
    <div class="container header-inner">
      ...
      <div class="header-actions">
        ...
        <button type="button" class="btn-primary" id="start-cta-btn" onclick="document.getElementById('start-modal').classList.add('is-open')">
          Начать
  ...
  <div class="mobile-drawer" aria-hidden="true">
    ...
    <div class="drawer-actions">
      ...
      <a href="https://tms.perevod4.ru/" target="_blank" rel="noopener" class="btn-link">Войти</a>
      <button type="button" class="btn-primary" onclick="document.getElementById('start-modal').classList.add('is-open')">Начать <svg class="arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 5l7 7-7 7"/></svg></button>
    </div>
  </div>

<!-- Попап «Начать» -->
<div id="start-modal" class="start-modal-overlay" role="dialog" aria-modal="true" aria-label="Как вы хотите продолжить?">
  <div class="start-modal">
    <div class="sm-blob sm-blob-1"></div>
    <div class="sm-blob sm-blob-2"></div>
    <div class="sm-blob sm-blob-3"></div>
    <div class="sm-blob sm-blob-4"></div>

    <button class="sm-close" type="button" aria-label="Закрыть" onclick="document.getElementById('start-modal').classList.remove('is-open')">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
    </button>

    <h2>Как вы хотите продолжить?</h2>

    <div class="sm-options">
      <a href="https://moscowtrans.ru/#calc-section" class="sm-option">
        <div class="sm-opt-text">
          <strong>Оформить заказ</strong>
          <span>Загрузите файл и получите расчёт онлайн за 1 минуту.</span>
        </div>
        <span class="sm-opt-btn"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 5l7 7-7 7"/></svg></span>
      </a>

      <a href="/stoimost-perevoda/" class="sm-option">
        <div class="sm-opt-text">
          <strong>Узнать стоимость</strong>
          <span>Воспользуйтесь онлайн-калькулятором перевода.</span>
        </div>
        <span class="sm-opt-btn"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 5l7 7-7 7"/></svg></span>
      </a>

      <a href="/stoimost-perevoda/#pricing" class="sm-option">
        <div class="sm-opt-text">
          <strong>Посмотреть тарифы</strong>
          <span>Тарифы по языковым парам и типам документов.</span>
        </div>
        <span class="sm-opt-btn"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 5l7 7-7 7"/></svg></span>
      </a>
    </div>

    <a href="/test-perevodchika/" class="sm-support">Переводчикам →</a>
  </div>
</div>
<script>
(function(){
